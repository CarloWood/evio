...
InputBuffer* Decoder::create_buffer(InputDevice* input_device, size_t buffer_full_watermark, size_t max_alloc)
{
  DoutEntering(dc::evio, "Decoder::create_buffer(" << input_device << ", " << buffer_full_watermark << ", " << max_alloc << ")");
...
size_t Decoder::end_of_msg_finder(char const* new_data, size_t rlen)
{
